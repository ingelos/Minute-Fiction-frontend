...
import AuthorProfileCard from "../../components/common/authorProfileCard/AuthorProfileCard.jsx";
    ...
    async function getUnpublishedStories() {
        ...
        try {
            ...
            if (error.response && error.response.status === 404) {
                console.error("Author has no unpublished stories");
            } else {
                console.error('Error fetching unpublished stories:', error);
                setError('Error fetching unpublished stories');
            }
        }
    }
    ...
    return (
        <section className='profile-section outer-content-container'>
            <div className='profile-section inner-content-container'>
                <div className='main-container author-profile-section'>
                    <div className="featured-section author-profile-section">
