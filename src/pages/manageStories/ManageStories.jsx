...
import FilterPanel from "../../components/common/filterPanel/FilterPanel.jsx";
                        ...
                        <div className="featured-section">
                            ...
                            <div className="relevant-stories-container">
                                <div className="relevant-stories-list">
                                    {loading && <p>Loading relevant stories...</p>}
                                    ...
                                    {!loading && searchClicked && (
                                        stories.length > 0 ? (
                                            ...
                                            <p className="no-stories-container">No stories available for the selected
                                                status and theme</p>
                                        ))}
                                </div>
                            </div>
